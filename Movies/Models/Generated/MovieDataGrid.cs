            ...
            internal class _MovieDataGrid
            {
                ...
                public class Item
                {
                        ...
                        public string int_integerField;
                                                [DataMember(Name = "urlPickerField", Order = 3)]
                        public string urlPickerField;
                                                [DataMember(Name = "colorField", Order = 4)]
                        public string colorField;
                                                [DataMember(Name = "dateTimePickerField", Order = 5)]
                        public string dateTimePickerField;
                                                [DataMember(Name = "dateTimeValueField_datetime", Order = 6)]
